                ...
                <div class="col-md-12">
                    <div class="panel panel-primary ">
                        ...
                        <div class="panel-body" style="margin: 10px;">
                            <div class="row">
                                <div class="col-md-3">
                                    <a href="order.jsp" class="btn btn-sm btn-primary btn-block active"><span class="glyphicon glyphicon-eye-open "></span> My Orders</a>
                                </div>
                                <div class="col-md-3">
                                    <a href="newOrder.jsp" class="btn btn-sm btn-primary btn-block"><span class="glyphicon glyphicon-plus"></span> Add New Order</a>
                                </div>
                            </div> 
                            <div class="row">
                                        ...
                                        <%
                                            try {
                                                ...
                                                if (!con.isClosed()) {
                                                    ...
                                                    ResultSet rs = statement.executeQuery("select * from order_informations where client_name = '"+user+"'");
                                                    while (rs.next()) {
                                        %>
                                        <tr>
