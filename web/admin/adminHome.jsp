                ...
                <div class="col-md-12">
                    <div class="panel panel-primary ">
                        <div class="panel-heading text-center">
                            <h3>Simplex Admin Dash Board </h3>
                            <h5><span><%= session.getAttribute("admin") %></span></h5>
                        </div>
                        <div class="panel-body" style="margin: 50px;">
                            <div class="row">
                                ...
                                <div class="col-md-4 " >
                                    <a href="client/client.jsp" class="btn btn-block btn-default " style="height:150px; padding:20px;">
                            ...
                            <div class="row" style="margin-top: 50px;">
                                ...
                                <div class="col-md-4" >
                                    <a href="" class="btn btn-block btn-default" style="height:150px; padding:20px;">
                                        <span class="glyphicon glyphicon-list text-primary" style="font-size: 90px;"></span><br>
